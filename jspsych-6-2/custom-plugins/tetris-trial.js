...
jsPsych.plugins["tetris-trial"] = (function() {
...
'</div>'+
 ...
 '</div>';
    ...
    var after_response = function(info) {
      ...
      display_element.querySelector('#jspsych-tetris-trial-stimulus').className += ' responded';
    ...
    if (trial.stimulus_duration !== null) {
      jsPsych.pluginAPI.setTimeout(function() {
        display_element.querySelector('#jspsych-tetris-trial-stimulus').style.visibility = 'hidden';
